...
#RMSE con la media del precio de las viviendas
RMSE_media<-RMSE(precio_medio,predicciones)
...
#RMSE con la media del precio de las viviendas
RMSE_media2<-RMSE(precio_medio,predicciones3)
RMSE_media2
...
#RMSE con la media del precio de las viviendas
RMSE_media3<-RMSE(precio_medio,p.rpart)
RMSE_media3
...
#RMSE con la media del precio de las viviendas
RMSE_media4<-RMSE(precio_medio,p.m5p)
RMSE_media4
...
RMSE_media5<-RMSE(predtest, precio_medio)
RMSE_media5
...
RMSE_media6<-RMSE(pred2, precio_medio)
RMSE_media6
...
RMSE_media7<-RMSE(predRF, precio_medio)
RMSE_media7
...
RMSE_media8<-RMSE(pred.RF, precio_medio)
RMSE_media8
...
RMSE_media9<-RMSE(pred.LM, precio_medio)
RMSE_media9

##CONCLUSIONES --> mejor RMSE --> stacking con LM como second level algorithm.
